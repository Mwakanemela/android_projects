...
import com.example.chatappupdate.calling.repository.MainRepository
import com.example.chatappupdate.calling.utils.DataModel
import com.example.chatappupdate.calling.utils.DataModelType
...
class MainActivity : AppCompatActivity(), UserAdapter.Listener, MainRepository.Listener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.i("GetUsername", "Main Activity")
        ...
        mainRepository.subscribeForLatestEvent { data: DataModel ->
            when (data.type) {
                DataModelType.StartCall -> {
                    Log.i("Debug", "data type is ${data.type}")
                    Log.i("Debug", "found data type is ${data.type}")
                    runOnUiThread {
