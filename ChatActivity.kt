...
import com.example.chatappupdate.msg_notification.NotificationData
import com.example.chatappupdate.msg_notification.PushNotification
import com.example.chatappupdate.msg_notification.RetrofitInstance
import com.example.chatappupdate.msg_notification.FirebaseService
...
class ChatActivity : AppCompatActivity() {
    ...
    //private lateinit var tokenDbRef: DatabaseReference
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val reference = database.getReference("chat_users")
        ...
        sendButton.setOnClickListener {
            ...
            getFCMByUserID(receiverUid!!) { notificationToken ->
                if (notificationToken != null) {
                    // You now have the user's name stored in the "name" variable
                    println("User's Name: $notificationToken")
                    receiverToken = notificationToken
                } else {
                    // Handle the case where the user's name is not found.
                    // You might want to display an error message or take appropriate action.
                    println("User's Name not found.")
                }
            }
    ...
    // Function to retrieve the fcm token of a user by user ID
    fun getFCMByUserID(userID: String, callback: (String?) -> Unit) {
        // Get a reference to your Firebase Realtime Database
        val databaseReference = FirebaseDatabase.getInstance().reference

        // Create a reference to the location where user data is stored
        val usersReference = databaseReference.child("chat_users")

        // Query the database to find the user's name by user ID
        usersReference.child(userID).child("notificationToken").addListenerForSingleValueEvent(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                // Retrieve the user's name
                val notificationToken = dataSnapshot.getValue(String::class.java)
